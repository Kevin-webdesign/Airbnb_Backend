...
export function bookingConfirmationEmail(name, listingName, checkIn, checkOut) {
    return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
...
export function bookingCancellationEmail(name, listingName, checkIn, checkOut, listingslink) {
    return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
