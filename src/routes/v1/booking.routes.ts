...
router.post("/",authenticate as RequestHandler , requireGuest as RequestHandler , createBooking);
router.delete("/:id", authenticate as RequestHandler , requireGuest as RequestHandler , deleteBooking);
router.put("/approve/:id", authenticate as RequestHandler  , requireHost as RequestHandler , changeBookingStatus);
router.put("/:id", authenticate as RequestHandler , requireGuest as RequestHandler , updateBooking);
