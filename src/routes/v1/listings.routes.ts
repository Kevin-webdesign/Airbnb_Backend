...
router.get("/dashboard", authenticate as RequestHandler, getDashboardListings);
router.get("/search", listingssearch);
router.get("/:id/conversations", authenticate as RequestHandler, getListingConversations);
router.get("/:id/messages", authenticate as RequestHandler, getListingMessages);
router.get("/:id", getListingById);

router.post("/", authenticate as RequestHandler, requireHost as RequestHandler, createListing);
router.post("/:id/messages", authenticate as RequestHandler, sendListingMessage);
router.put("/:id", authenticate as RequestHandler, updateListing);
router.delete("/:id", authenticate as RequestHandler, deleteListing);
